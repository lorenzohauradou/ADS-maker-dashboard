...
import { MoreHorizontal, Calendar, Clock, ImageIcon, Play, Edit, Trash2 } from "lucide-react"
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
        {projects.map((project) => (
          <Card
            key={project.id}
            className={`${project.cardBg} border-slate-200 dark:border-zinc-800 overflow-hidden hover:shadow-lg transition-all duration-300 group hover:scale-105 rounded-xl`}
          >
            {/* Project Thumbnail */}
