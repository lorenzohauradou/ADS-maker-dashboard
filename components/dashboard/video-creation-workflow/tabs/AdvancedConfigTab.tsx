...
import { Volume2, Sparkles, Crown, Globe, CheckCircle } from "lucide-react"
    ...
    return (
        <div className="space-y-8 mt-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Audio Controls */}
                <Card className="bg-gradient-to-r from-violet-50 to-purple-50 dark:from-violet-900/20 dark:to-purple-900/20 p-6 border-2 border-violet-200 dark:border-violet-800 rounded-xl">
                ...
                {/* Creative Controls */}
                <Card className="bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 p-6 border-2 border-emerald-200 dark:border-emerald-800 rounded-xl">
            ...
            <Card className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 p-6 border-2 border-yellow-200 dark:border-yellow-800 rounded-xl">
            ...
            <Card className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 p-6 border-2 border-indigo-200 dark:border-indigo-800 rounded-xl">
                <h3 className="text-xl font-bold mb-6 text-slate-900 dark:text-white flex items-center">
